...
export function CustomNavbar({ name, icon }: { name: string, icon: ReactNode }) {
    ...
    return (
        ...
        text-zinc-400 dark:text-zinc-500">
                ...
                dark:bg-white/[0.03] dark:border-white/5 dark:hover:bg-white/10 dark:hover:border-cyan-500/30 dark:hover:text-cyan-400 ${i === breadcrumb.length - 1 ? 'pointer-events-none' : ''}`}
                        >
                            {item.icon}
